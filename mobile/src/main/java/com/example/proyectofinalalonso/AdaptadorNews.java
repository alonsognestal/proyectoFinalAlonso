...
public class AdaptadorNews extends FirebaseRecyclerAdapter<Genero, AdaptadorNews.EventoViewHolder> {
    private LayoutInflater inflater;
    private Context context;

    //Al adaptador, en vez de pasarle un vector o un arraylist le tengo que pasar la base de datos de Firebase.
    public AdaptadorNews(int modelLayout, DatabaseReference ref) {
        super(Genero.class, modelLayout, AdaptadorNews.EventoViewHolder.class,ref);
    }
